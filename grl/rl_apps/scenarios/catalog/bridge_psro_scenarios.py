...
from grl.rl_apps.kuhn_4p_happo_full_obs_larger import kuhn_HATrainer_4P_full_obs_larger, kuhn_HAPPOTorchPolicy_4P_full_obs_larger
...
scenario_catalog.add(PSROScenario(
    ...
    trainer_class=kuhn_HATrainer_4P_full_obs_larger,
    policy_classes={
        "metanash": kuhn_HAPPOTorchPolicy_4P_full_obs_larger,
        "best_response":kuhn_HAPPOTorchPolicy_4P_full_obs_larger,
        "eval": kuhn_HAPPOTorchPolicy_4P_full_obs_larger,
    },
    num_eval_workers=8,
    ...
    get_trainer_config=s_psro_kuhn_ccppo_params_larger,
    ...
    psro_get_stopping_condition=lambda: EpisodesSingleBRRewardPlateauStoppingCondition(
        ...
        dont_check_plateau_before_n_episodes=int(2.5e4),
        check_plateau_every_n_episodes=int(1e4),
        minimum_reward_improvement_otherwise_plateaued=0.005,
