...
CCPPOTorchPolicy_4P_full_obs = PPOTorchPolicy.with_updates(
...
def get_policy_class(config):
    if config["framework"] == "torch":
        return CCPPOTorchPolicy_4P_full_obs


CCTrainer_4P_full_obs = PPOTrainer.with_updates(
    name="CCPPOTrainer_full_obs",
