...
def get_policy_class(config):
    if config["framework"] == "torch":
        return kuhn_CCPPOTorchPolicy_4P_full_obs_larger


kuhn_CCTrainer_4P_full_obs_larger = PPOTrainer.with_updates(
    name="kuhn_CCPPOTrainer_full_obs_larger",
...
if __name__ == "__main__":
    ...
    config = {
        ...
        "multiagent": {
            "policies": {
                "pol1": (None, tmp_env.observation_space, Discrete(25), {
                    "framework": "torch",
                }),
            },
        ...
        "model": {
            "custom_model": "cc_model_full_obs_larger_kuhn",
    ...
    results = tune.run(CCTrainer_4P_full_obs_larger, config=config, stop=stop, verbose=1)
